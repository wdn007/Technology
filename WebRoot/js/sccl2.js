	...
	for(var i=0; i<menu.length; i++){   
		...
		try{
			if(item.isHeader == "1"){
				...
				item.icon == "" ? item.icon = "&#xe601" : item.icon = item.icon;
				if(item.childMenus == ""){
...
$(function(){
	...
	var menu = [{"id":"1","name":"主菜单","parentId":"0","url":"","icon":"","order":"1","isHeader":"1","childMenus":[
					{"id":"2","name":"竞赛管理","parentId":"1","url":"","icon":"&#xe607;","order":"1","isHeader":"0","childMenus":[
					      {"id":"6","name":"赛事发布","parentId":"2","url":"View/raceUpload.jsp","icon":"&#xe612;","order":"1","isHeader":"0","childMenus":""},
					      {"id":"7","name":"赛事编辑","parentId":"2","url":"View/raceT.jsp","icon":"&#xe612;","order":"1","isHeader":"0","childMenus":""},
					      
					      {"id":"8","name":"报名统计","parentId":"2","url":"EntryForm/listEntryFormInfo","icon":"&#xe612;","order":"1","isHeader":"0","childMenus":""}
					]},
					{"id":"3","name":"新闻管理","parentId":"1","url":"","icon":"&#xe602;","order":"1","isHeader":"0","childMenus":[
					      {"id":"9","name":"新闻发布","parentId":"3","url":"View/newsUpload.jsp","icon":"&#xe612;","order":"1","isHeader":"0","childMenus":""},
					      {"id":"10","name":"新闻编辑","parentId":"3","url":"View/newsT.jsp","icon":"&#xe612;","order":"1","isHeader":"0","childMenus":""}
					]},
					{"id":"4","name":"信息管理","parentId":"1","url":"","icon":"&#xe609;","order":"1","isHeader":"0","childMenus":[
					      {"id":"11","name":"个人资料","parentId":"4","url":"Teacher/listTecInfoSingle","icon":"&#xe612;","order":"1","isHeader":"0","childMenus":""}
					]},
					{"id":"5","name":"文件管理","parentId":"1","url":"","icon":"&#xe610;","order":"1","isHeader":"0","childMenus":[
					      {"id":"12","name":"文件上传","parentId":"5","url":"View/uploadFile.jsp","icon":"&#xe612;","order":"1","isHeader":"0","childMenus":""},
					      {"id":"13","name":"文件编辑","parentId":"5","url":"Upload/myFileList","icon":"&#xe612;","order":"1","isHeader":"0","childMenus":""}
					]}
				]}];
