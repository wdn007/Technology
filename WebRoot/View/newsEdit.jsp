...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("select[name='academy']").find("option[value='${newsInfo.academy}']").attr("selected", true);
...
<body>
<form action="News/updateNewsInfo" method="post" enctype="multipart/form-data" id="myForm">
    <input type="hidden" name="accessory" value="${newsInfo.accessory}"/>
    <input type="hidden" name="username" value="${newsInfo.username}"/>
    <input type="hidden" name="visitCount" value="${newsInfo.visitCount}"/>
    <table class="uploadTable">
        ...
        <tr>
            ...
            <td class="r_td"><input name="title" type="text" value="${newsInfo.title}"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="r_td"><textarea cols="100" id="detail" name="detail" rows="10">${newsInfo.detail}</textarea></td>
        </tr>
        <tr>
            <td class="l_td"></td>
