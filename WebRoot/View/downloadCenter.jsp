        ...
        <div class="login-m">
            ...
            <div class="main">
                <div class="m col-md-10">
                    <div class="tom">
                        <div class="totitle"><a
                                href="${pageContext.request.contextPath}/Upload/showDownloadList">下载中心<span></span></a>
                        </div>
                        <div class="toinfo">当前位置：<a href="${pageContext.request.contextPath}">网站首页</a> &gt;
                            <a href="${pageContext.request.contextPath}/Upload/showDownloadList">下载中心</a></div>
                    </div>
                    <div class="blk4 bf"></div>
                    <ul class="list">
                        <c:forEach items="${UploadInfoList}" var="myList">
                            <li><span class="stitle"><a href="javascript:void(0);"
                                                        onclick="doDownload('${ myList.path }')"
                                                        title="${fn:substring(myList.path, fn:indexOf(myList.path, '_') + 1, fn:length(myList.path))}"
                                                        class="red0">${fn:substring(myList.path, fn:indexOf(myList.path, '_') + 1, fn:length(myList.path))} </a></span><span
                                    class="stype">${ myList.username }</span><span class="sdate"><fmt:formatDate
                                    value="${ myList.uploadTime }" pattern="yyyy-MM-dd"/></span></li>
                        </c:forEach>
                    </ul>
                    <div class="page">
                        <div class="info">
...
<script type="text/javascript">
    function gotoPage(pageNum) {
        ...
        myForm.method = "get";
        myForm.action = "Upload/showDownloadList";
