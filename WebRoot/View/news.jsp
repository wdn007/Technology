...
<head>
    ...
    <script type="text/javascript">
        ...
        function editStuInfo() {
            ...
            var title = '新闻审核';
            if (row) {
                url = 'News/checkNewsInfo?newsID=' + row.newsID;
...
<table id="dg" title="Management" class="easyui-datagrid" style="width:1000px;height:450px"
    ...
    <tr>
        ...
        <th field="uploadID" width="120px">发布者工号</th>
        <th field="academy" width="120px">发布学院</th>
        <th field="status" width="100px">审核状态</th>
...
<div id="toolbar">
    <a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editStuInfo()">Check
        Item</a>
    <div>
        <span>起止时间:</span>
        ...
        <span>（为空则查询指定日期）</span>
        <span>学院:</span>
        <select id="academy" style="width:150px;line-height:26px;border:1px solid #ccc;height:30px;">
            <option value=""></option>
