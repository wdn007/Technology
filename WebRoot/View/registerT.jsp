    ...
    <div class="center">
        ...
        <div class="login-m">
            ...
            <div class="container" style="margin-bottom: 30px;">
                <dl class="cm">
                    <dt>桂林电子科技大学科技竞赛官网-(教师账号)注册</dt>
                    <dd>
                        <div class="alert alert-danger">
                            <p><b>说明：</b>只允许（桂林电子科技大学）教师用户注册，请认真填写正确信息，填写虚假信息无效！</p>
                        </div>
                        <div class="form-list form-main-list">

                            <form action="Teacher/register" id="form1" method="post" name="form1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-item">
                                        ...
                                        <input class="form-text" data-val="true" data-val-required="请输入姓名！"
                                               id="MemberName" name="username" placeholder="姓名" type="text" value=""/>
                                        <span class="field-validation-valid" data-valmsg-for="MemberName"
                                              data-valmsg-replace="true"></span>
                                    </div>
                                    <div class="form-item">
                                        <div class="form-label">
                                            <span class="star">*</span><label for="MemberNo">工号</label>
                                        </div>
                                        <input class="form-text" data-val="true" data-val-length="学号6-20位"
                                               data-val-length-max="20" data-val-length-min="6"
                                               data-val-remote="该工号已经注册过账号！"
                                               data-val-remote-additionalfields="*.MemberNo" data-val-remote-type="post"
                                               data-val-remote-url="/Register/MemberNo" data-val-required="请输入正确的工号！"
                                               id="MemberNo" name="jobID" placeholder="教师工号，可用作登陆账号" type="text"
                                               value=""/>
                                    ...
                                    <div class="form-item">
                                        <div class="form-label">
                                            <span class="star">*</span><label for="Specialty">职称</label>
                                        </div>
                                        <input class="form-text" data-val="true" data-val-length="专业4-30位"
                                               data-val-length-max="30" data-val-length-min="4"
                                               data-val-required="请输入职称！" id="Specialty" name="duties"
                                               placeholder="请输入职称" type="text" value=""/>
