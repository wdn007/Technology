        ...
        <div class="login-m">
            ...
            <div class="main">
                <div class="m col-md-10">
                    <div class="tom">
                        <div class="totitle"><a
                                href="${pageContext.request.contextPath}/Race/showRaceList">赛事公告<span></span></a></div>
                    ...
                    <ul class="list">
                        <c:forEach items="${RaceInfoList}" var="myList">
                            <c:url value="Race/raceDetail" var="link">
                                <c:param name="raceID" value="${ myList.raceID }"></c:param>
                            </c:url>
                            <li><span class="stitle"><a href="${ link }" rel="external nofollow" target="_blank"
                                                        title="${ myList.title }"
                                                        class="red0">${ myList.title }</a></span><span
                                    class="stype">${ myList.sponsor }</span><span class="sdate"><fmt:formatDate
...
<script type="text/javascript">
    function gotoPage(pageNum) {
        ...
        myForm.method = "get";
        myForm.action = "Race/showRaceList";
